                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box bg-light shadow">
                          <span class="info-box-icon bg-purple elevation-1"><i class="fas fa-folder"></i></span>
                          <div class="info-box-content">
                          ...
                          <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box bg-light shadow">
                              ...
                              <div class="info-box-content">
                                ...
                                <span class="info-box-number text-right">
                                  <?php
                                  echo $conn->query("SELECT * FROM `user_list`")->num_rows;
                                  ?>
                                </span>
                              </div>
                            </div>
                  ...
                  <div class="card-footer"
                    ...
                    <img src="assets/neo.jpg" style="max-width: 100px; max-height: 100px; margin-right: 20px;">
                    <h6 style="margin: 0; text-align: center;">Komplek Taman Budaya Sentul City, Jl. Siliwangi No.1,
