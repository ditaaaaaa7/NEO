                    ...
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="create_pr.php" class="btn btn-danger btn-md"><span class="fas fa-plus"></span>
                                    Create New</a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            while ($row = mysqli_fetch_array($data)) {
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a type="button" class="btn btn-dark btn-md"
                                                        href="edit_pr.php?id=<?= $row[0] ?>"><span class="fa fa-edit"
                                                            data-toggle="tooltip" data-placement="top" title="Edit"></span>
                                                    </a>
                                                    <a type="button" class="btn btn-info btn-md"
                                                        href="view_pr.php?id=<?= $row[0] ?>"><span class="fa fa-eye"
