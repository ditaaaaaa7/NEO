            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 style=" font-weight: bold;">Item List</h1>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="add_item.php" class="btn btn-danger btn-md"><span class="fas fa-plus"></span> Add
                                    New</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="container-fluid">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM item_list ORDER BY 'item_id' DESC";
                                            ...
                                            while ($row = mysqli_fetch_array($data)) {
                                                ...
                                                <td align="center">
                                                    <a type="button" class="btn btn-dark btn-md"
                                                        href="edit_item.php?item_id=<?= $row[0] ?>"><span class="fa fa-edit"
                                                    ...
                                                    <a onclick="return confirm('Are you sure to delete this item?')"
                                                        ...
                                                        href="delete_item.php?item_id=<?= $row[0] ?>"><span class="fa fa-trash"
                                                            ...
                                                            <div class="modal-content" align="left">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="modalLabel"><span
                                                                            class="fa fa-book"></span> Item Details</h5>
                                                                </div>
                                                                        ...
                                                                        <fieldset class="w-100">
                                                                            <div class="col-12">
                                                                                <dl>
                                                                                    ...
                                                                                    <dd class="pl-3" id="unit"></dd>
                                                                                    <dt class="text-danger">Types of Item:</dt>
                                                                                    <dd class="pl-3" id="type"></dd>
                                                                                    <dt class="text-danger">Cost:</dt>
                                                                                    <dd class="pl-3" id="cost"></dd>
                                                                                </dl>
                                                                            </div>
                                                                        </fieldset>
                                                                    </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#example1').on('click', 'a.btn-info', function () {
                    ...
                    var cost = row.find('td:nth-child(5)').text();

                    $('#myModal #name').text(name);
                    $('#myModal #unit').text(unit);
                    $('#myModal #type').text(type);
                    $('#myModal #cost').text(cost);
