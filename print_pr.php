...
if(isset($_GET['id'])) {
  ...
  if($result && mysqli_num_rows($result) > 0) {
    ...
    echo "<html>";
    echo "<head>";
    echo "<title>Purchase Request Details</title>";
    ...
    echo "<h3 style='font-family: Quicksand, sans-serif; margin-top: 0px; margin-left: -200px;'><b> Hotel NEO+ Green Savana </b></h3>";
    echo "</div>";
    echo "<div class='header-right'>";
    echo "<p style='font-size: 16px; margin-top: -10px;'><b>Purchase Request</b></p>";
    echo "</div>";
    echo "</div>";
    echo "<div class='header-container'>";
    echo "<div class='header-left'>";
