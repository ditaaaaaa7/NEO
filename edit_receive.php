                ...
                <section class="content-header">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Receiving for Purchase Order</h3>
                        </div>
                        <div class="card-body">
                            <div class="container-fluid">
                                <form method="post" enctype="multipart/form-data" action="">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <a class="btn btn-md btn-secondary" href="receiving.php">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
WHERE id_po = $editId AND detail_id = {$itemDetail['detail_id']}";
                                ...
                                if ($result) {
                                    echo "<script>
                                        Swal.fire({
                                            title: 'Updated!',
                                            text: 'Purchase Order Successfully Received.',
                                            icon: 'success'
                                        }).then((result) => {
                                    ...
                                    echo "<script>
                                            swal({
                                                title: 'Error!',
                                                text: 'Failed Purchase Order for Received! " . mysqli_error($conn) . "',
                                                icon: 'error',
                                            });
                                        </script>";
                                }
