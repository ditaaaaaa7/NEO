                ...
                <section class="content-header">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <?php
                            $title = 'Receiving Order Details - ' . $row_pr['po_code'];
                            ...
                            <div class="card-tools">
                                ...
                                <a class="btn btn-secondary" href="receiving.php"><span class="fas fa-arrow-left"></span>
                                    Back</a>
                            </div>
                        </div>
        ...
        <script>
            ...
            printButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    window.open(`print_rr.php?id=${id}`, '_blank');
                });
            });
        </script>
    </body>
